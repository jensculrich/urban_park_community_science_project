...
model {
  ...
  // evaluate the likelihood of the data in each city
  for(CITY in 1:n_cities){
    
    for(i in 1:n_species[CITY]){
      for(j in 1:n_sites[CITY]){
        for(k in 1:n_years[CITY]){
            
            if (sum(V[CITY,i,j,k]) > 0){ // lp observed 
              ...
              target += (log(psi[CITY,i,j,k]) + // present
                             bernoulli_lpmf(V[CITY,i,j,k,1]|p[CITY,i,j,k,1])*V_NA[CITY,i,j,k,1] + 
                             bernoulli_lpmf(V[CITY,i,j,k,2]|p[CITY,i,j,k,2])*V_NA[CITY,i,j,k,2] + 
                             bernoulli_lpmf(V[CITY,i,j,k,3]|p[CITY,i,j,k,3])*V_NA[CITY,i,j,k,3] + 
                             bernoulli_lpmf(V[CITY,i,j,k,4]|p[CITY,i,j,k,4])*V_NA[CITY,i,j,k,4] +
                             bernoulli_lpmf(V[CITY,i,j,k,5]|p[CITY,i,j,k,5])*V_NA[CITY,i,j,k,5] + 
                             bernoulli_lpmf(V[CITY,i,j,k,6]|p[CITY,i,j,k,6])*V_NA[CITY,i,j,k,6] +
                             bernoulli_lpmf(V[CITY,i,j,k,7]|p[CITY,i,j,k,7])*V_NA[CITY,i,j,k,7] + 
                             bernoulli_lpmf(V[CITY,i,j,k,8]|p[CITY,i,j,k,8])*V_NA[CITY,i,j,k,8] +
                             bernoulli_lpmf(V[CITY,i,j,k,9]|p[CITY,i,j,k,9])*V_NA[CITY,i,j,k,9] + 
                             bernoulli_lpmf(V[CITY,i,j,k,10]|p[CITY,i,j,k,10])*V_NA[CITY,i,j,k,10] +
                             bernoulli_lpmf(V[CITY,i,j,k,11]|p[CITY,i,j,k,11])*V_NA[CITY,i,j,k,11] + 
                             bernoulli_lpmf(V[CITY,i,j,k,12]|p[CITY,i,j,k,12])*V_NA[CITY,i,j,k,12]
                         );
              ...
              target += (log_sum_exp(log(psi[CITY,i,j,k]) + log1m(p[CITY,i,j,k,1])*V_NA[CITY,i,j,k,1] + 
                                                       log1m(p[CITY,i,j,k,2])*V_NA[CITY,i,j,k,2] + 
                                                       log1m(p[CITY,i,j,k,3])*V_NA[CITY,i,j,k,3] + 
                                                       log1m(p[CITY,i,j,k,4])*V_NA[CITY,i,j,k,4] +
                                                       log1m(p[CITY,i,j,k,5])*V_NA[CITY,i,j,k,5] + 
                                                       log1m(p[CITY,i,j,k,6])*V_NA[CITY,i,j,k,6] +
                                                       log1m(p[CITY,i,j,k,7])*V_NA[CITY,i,j,k,7] + 
                                                       log1m(p[CITY,i,j,k,8])*V_NA[CITY,i,j,k,8] +
                                                       log1m(p[CITY,i,j,k,9])*V_NA[CITY,i,j,k,9] + 
                                                       log1m(p[CITY,i,j,k,10])*V_NA[CITY,i,j,k,10] +
                                                       log1m(p[CITY,i,j,k,11])*V_NA[CITY,i,j,k,11] + 
                                                       log1m(p[CITY,i,j,k,12])*V_NA[CITY,i,j,k,12],
                                      // or just simple no occurrence
                                      log1m(psi[CITY,i,j,k])));
            } // end if/else
