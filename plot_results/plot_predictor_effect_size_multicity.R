...
stan_out <- readRDS("./model_outputs/stan_out_LA_2km_connectivity_family_100buffers.rds")
stan_out2 <- readRDS("./model_outputs/stan_out_NYC_2km_connectivity_family_100buffers.rds")
