...
Y <- c(# family level inference
       ...
       fit_summary2$summary[6,1] # psi1 - tree cover
)
...
lower_95 <- c(# family level inference
  ...
  fit_summary2$summary[6,4] # psi1 - tree cover
)
...
upper_95 <- c(# family level inference
  ...
  fit_summary2$summary[6,8] # psi1 - tree cover
)
...
lower_50 <- c(# family level inference
  ...
  fit_summary2$summary[6,5] # psi1 - tree cover
)
...
upper_50 <- c(# family level inference
  ...
  fit_summary2$summary[6,7] # psi1 - tree cover
)
