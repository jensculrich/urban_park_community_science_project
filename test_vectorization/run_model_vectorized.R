...
source("./test_vectorization/prep_data_vectorized.R")
...
saveRDS(my_data, paste0("./test_vectorization/prepped_data_", region, ".rds"))
my_data <- readRDS( paste0("./test_vectorization/prepped_data_", region, ".rds"))
