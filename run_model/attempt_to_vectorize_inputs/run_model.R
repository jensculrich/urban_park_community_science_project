...
source("./run_model/april_2025/prep_data.R")

min_species_detections <- 20 # binary park/year/species detections
...
stan_model <- "./models/april_2025/dynamic_occupancy_model.stan"
...
saveRDS(stan_out, "./model_outputs/stan_out_new.rds")
