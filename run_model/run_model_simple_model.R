...
stan_model <- "./models/dynamic_occupancy_model_simple.stan"
...
saveRDS(stan_out, paste0("./model_outputs/stan_out_", city, "_2km_connectivity_family_50buffers_simple.rds"))
